        ...
        try {
            ...
            const permissionsData = [
                ...
                { name: 'boards:delete', description: 'Delete boards' },
                {
                    name: 'boards:manage',
                    description:
                        'Full board management including member management',
                },
            ...
            for (const permData of permissionsData) {
                ...
                if (!permission) {
                    ...
                    console.log(
                        `⏭️  Permission already exists: ${permData.name}`
                    );
                }
            ...
            const rolesData = [
                ...
                },
                {
                    name: 'board_admin',
                    description:
                        'Board Administrator - Manage board content and members',
                    permissions: permissionsData
                        .filter(
                            (p) =>
                                p.name === 'boards:read' ||
                ...
                },
                {
                    name: 'guest',
                    description:
                        'Guest User - Limited access to specific boards',
                    permissions: permissionsData
                        .filter(
                            (p) =>
                                p.name === 'boards:read' ||
